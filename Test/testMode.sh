...
echo "╔═══════════════════════════════════════════════════════════════════════════╗";
echo "║                                                                           ║";
echo "║  Se ha ejecutado correctamente el script con numero de repeticiones $1    ║";
echo "║                                                                           ║";
echo "║  Ahora se debe montar el LiveServer (o si esta montado se recargara solo) ║";
echo "║  Y apretar el boton 'AGREGAR'                                             ║";
echo "║                                                                           ║";
echo "╚═══════════════════════════════════════════════════════════════════════════╝";